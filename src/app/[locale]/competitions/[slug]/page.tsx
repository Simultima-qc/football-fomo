...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${BASE_URL}/${locale}/competitions/${slug}`,
      languages: {
        en: `${BASE_URL}/en/competitions/${slug}`,
        fr: `${BASE_URL}/fr/competitions/${slug}`,
        "x-default": `${BASE_URL}/en/competitions/${slug}`,
      },
    },
  };
}
...
export async function generateStaticParams() {
  const entities = await getEntitiesByType("COMPETITION");
...
export default async function CompetitionPage({ params }: Props) {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: locale === "fr" ? "Compétitions" : "Competitions", item: `${BASE_URL}/${locale}/competitions` },
      { "@type": "ListItem", position: 3, name, item: `${BASE_URL}/${locale}/competitions/${slug}` },
    ],
  };
      ...
      <main className="flex-1 bg-zinc-950 text-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
          ...
          >
            ...
            {locale === "fr" ? "Compétitions" : "Competitions"}
          </Link>
          ...
          {items.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-zinc-500">
                {locale === "fr"
                  ? "Aucune actualité pour cette compétition pour le moment."
                  : "No news for this competition yet."}
              </p>
            </div>
          )}
