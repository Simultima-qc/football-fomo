...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: locale === "fr" ? "Compétitions" : "Competitions",
    description:
      locale === "fr"
        ? "Suivez l'actualité des compétitions de football sur FootballFOMO."
        : "Follow the latest football competition news on FootballFOMO.",
    alternates: {
      canonical: `${BASE_URL}/${locale}/competitions`,
      languages: {
        en: `${BASE_URL}/en/competitions`,
        fr: `${BASE_URL}/fr/competitions`,
        "x-default": `${BASE_URL}/en/competitions`,
      },
    },
  };
}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {entities.map((entity: any) => {
              ...
              return (
                <Link
                  key={entity.id}
                  href={`/${locale}/competitions/${entity.slug}`}
